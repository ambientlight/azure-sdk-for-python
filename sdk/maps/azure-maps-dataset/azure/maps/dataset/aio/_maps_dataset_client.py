...
from ._configuration import MapsDatasetClientConfiguration
from .operations import DatasetOperations
from .. import models


class MapsDatasetClient(object):
    """APIs for managing datasets from uploaded data in Azure Maps.

    :ivar dataset: DatasetOperations operations
    :vartype dataset: azure.maps.dataset.aio.operations.DatasetOperations
    ...
    :type geography: str or ~azure.maps.dataset.models.Geography
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsDatasetClientConfiguration(credential, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsDatasetClient":
