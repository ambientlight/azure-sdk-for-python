...
class DatasetOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.maps.dataset.models.LongRunningOperationResult]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.maps.dataset.models.DatasetListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
