...
class DatasetOperations(object):
    ...
    :type models: ~azure.maps.dataset.models
    ...
    def _create_initial(
        ...
        description_dataset=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.dataset.models.LongRunningOperationResult]
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.maps.dataset.models.DatasetListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.DatasetDetailInfo"
        """**Applies to:** see pricing `tiers <https://aka.ms/AzureMapsPricingTier>`_.
        ...
        :rtype: ~azure.maps.dataset.models.DatasetDetailInfo
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_operation(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.dataset.models.LongRunningOperationResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.LongRunningOperationResult"]
        error_map = {
