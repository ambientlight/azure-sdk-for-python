...
class MapsDatasetClientConfiguration(Configuration):
    """Configuration for MapsDatasetClient.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(MapsDatasetClientConfiguration, self).__init__(**kwargs)

        self.credential = credential
        self.geography = geography
        self.api_version = "2.0"
        self.credential_scopes = kwargs.pop('credential_scopes', ['https://atlas.microsoft.com/.default'])
        kwargs.setdefault('sdk_moniker', 'maps-dataset/{}'.format(VERSION))
