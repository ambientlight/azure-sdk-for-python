...
class MapsGeolocationClient(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsGeolocationClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsGeolocationClient":
