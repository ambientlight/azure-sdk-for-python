...
class MapsFeaturestateClientConfiguration(Configuration):
    """Configuration for MapsFeaturestateClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(MapsFeaturestateClientConfiguration, self).__init__(**kwargs)

        self.credential = credential
        self.geography = geography
        self.api_version = "2.0"
        self.credential_scopes = kwargs.pop('credential_scopes', ['https://atlas.microsoft.com/.default'])
        kwargs.setdefault('sdk_moniker', 'maps-featurestate/{}'.format(VERSION))
