...
from ._configuration import MapsFeaturestateClientConfiguration
from .operations import FeatureStateOperations
from .. import models


class MapsFeaturestateClient(object):
    """APIs for managing the dynamic feature states in Azure Maps.

    :ivar feature_state: FeatureStateOperations operations
    :vartype feature_state: azure.maps.featurestate.aio.operations.FeatureStateOperations
    ...
    :type geography: str or ~azure.maps.featurestate.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsFeaturestateClientConfiguration(credential, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsFeaturestateClient":
