...
# client = CreatorClient('None', authentication_policy=AzureKeyInQueryCredentialPolicy(AzureKeyCredential(os.environ.get("SUBSCRIPTION_KEY")), "subscription-key"))
client = CreatorClient(DefaultAzureCredential(), x_ms_client_id=os.environ.get("CLIENT_ID", None), headers_policy=HeadersPolicy({'x-ms-client-id': os.environ.get("CLIENT_ID", None)}))
