...
from ._configuration import MapsWFSClientConfiguration
from .operations import WFSOperations
from .. import models


class MapsWFSClient(object):
    """Azure Maps Web Feature REST APIs.

    :ivar wfs: WFSOperations operations
    :vartype wfs: azure.maps.wfs.aio.operations.WFSOperations
    ...
    :type geography: str or ~azure.maps.wfs.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsWFSClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsWFSClient":
