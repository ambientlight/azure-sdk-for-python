...
class MapsWFSClientConfiguration(Configuration):
    """Configuration for MapsWFSClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(MapsWFSClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-wfs/{}'.format(VERSION))
