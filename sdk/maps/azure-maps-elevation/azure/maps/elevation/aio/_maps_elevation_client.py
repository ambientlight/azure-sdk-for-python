...
from ._configuration import MapsElevationClientConfiguration
from .operations import ElevationOperations
from .. import models


class MapsElevationClient(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsElevationClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsElevationClient":
