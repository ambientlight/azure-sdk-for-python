...
from ._configuration import MapsSpatialClientConfiguration
from .operations import SpatialOperations
from .. import models


class MapsSpatialClient(object):
    """Azure Maps Spatial REST APIs.

    :ivar spatial: SpatialOperations operations
    :vartype spatial: azure.maps.spatial.aio.operations.SpatialOperations
    ...
    :type geography: str or ~azure.maps.spatial.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsSpatialClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsSpatialClient":
