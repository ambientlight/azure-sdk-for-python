...
class MapsSpatialClientConfiguration(Configuration):
    """Configuration for MapsSpatialClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(MapsSpatialClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-spatial/{}'.format(VERSION))
