...
class SpatialOperations(object):
    ...
    :type models: ~azure.maps.spatial.models
    ...
    def get_geofence(
        ...
        **Applies to:** S1 Pricing tier.
        ...
        :type format: str or ~azure.maps.spatial.models.ResponseFormat
        ...
        :type mode: str or ~azure.maps.spatial.models.GeofenceMode
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GeofenceResponse, or the result of cls(response)
        :rtype: ~azure.maps.spatial.models.GeofenceResponse
    ...
    def post_geofence(
        ...
        **Applies to:** S1 Pricing tier.
        ...
        :type search_geofence_request_body: ~azure.maps.spatial.models.GeoJsonFeatureCollection
        :param z: The sea level in meter of the location being passed. If this parameter is presented,
    ...
    def post_buffer(
        ...
        **kwargs  # type: Any
        ...
        :type buffer_request_body: ~azure.maps.spatial.models.BufferRequestBody
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BufferResponse, or the result of cls(response)
        :rtype: ~azure.maps.spatial.models.BufferResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def post_closest_point(
        ...
        **kwargs  # type: Any
        ...
        :type closest_point_request_body: ~azure.maps.spatial.models.GeoJsonFeatureCollection
        ...
        :rtype: ~azure.maps.spatial.models.ClosestPointResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def post_point_in_polygon(
        ...
        **kwargs  # type: Any
        ...
        :type point_in_polygon_request_body: ~azure.maps.spatial.models.GeoJsonFeatureCollection
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: PointInPolygonResponse, or the result of cls(response)
        :rtype: ~azure.maps.spatial.models.PointInPolygonResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_great_circle_distance(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.spatial.models.GreatCircleDistanceResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
