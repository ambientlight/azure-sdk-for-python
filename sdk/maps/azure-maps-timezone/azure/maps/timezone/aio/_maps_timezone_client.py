...
class MapsTimezoneClient(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsTimezoneClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsTimezoneClient":
