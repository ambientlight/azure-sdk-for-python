...
class MapsWeatherClient(object):
    """MapsWeatherClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsWeatherClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsWeatherClient":
