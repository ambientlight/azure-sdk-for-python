...
class AliasOperations:
    ...
    :type models: ~azure.maps.alias.models
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.maps.alias.models.AliasesCreateResponse
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.maps.alias.models.AliasListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def assign(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.maps.alias.models.AliasListItem
        :raises: ~azure.core.exceptions.HttpResponseError
        """
