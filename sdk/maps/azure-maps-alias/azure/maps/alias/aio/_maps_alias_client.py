...
from ._configuration import MapsAliasClientConfiguration
from .operations import AliasOperations
from .. import models


class MapsAliasClient(object):
    """APIs for managing aliases in Azure Maps.

    :ivar alias: AliasOperations operations
    :vartype alias: azure.maps.alias.aio.operations.AliasOperations
    ...
    :type geography: str or ~azure.maps.alias.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsAliasClientConfiguration(credential, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsAliasClient":
