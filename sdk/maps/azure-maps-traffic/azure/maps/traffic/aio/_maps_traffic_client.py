...
from ._configuration import MapsTrafficClientConfiguration
from .operations import TrafficOperations
from .. import models


class MapsTrafficClient(object):
    """Azure Maps Traffic REST APIs.

    :ivar traffic: TrafficOperations operations
    :vartype traffic: azure.maps.traffic.aio.operations.TrafficOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsTrafficClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsTrafficClient":
