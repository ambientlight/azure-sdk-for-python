...
class ConversionOperations:
    ...
    async def begin_convert(
        ...
        *diagnostic package* to visualize and diagnose these issues. In case any issues are encountered
        ...
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.maps.conversion.models.LongRunningOperationResult]
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.maps.conversion.models.ConversionListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
