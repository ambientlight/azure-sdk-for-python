...
from ._configuration import MapsConversionClientConfiguration
from .operations import ConversionOperations
from .. import models


class MapsConversionClient(object):
    """APIs for converting DWG Packages in Azure Maps.

    :ivar conversion: ConversionOperations operations
    :vartype conversion: azure.maps.conversion.aio.operations.ConversionOperations
    ...
    :type geography: str or ~azure.maps.conversion.models.Geography
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsConversionClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsConversionClient":
