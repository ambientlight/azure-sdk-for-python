...
class MapsConversionClientConfiguration(Configuration):
    """Configuration for MapsConversionClient.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(MapsConversionClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-conversion/{}'.format(VERSION))
