...
class DataOperations(object):
    ...
    :type models: ~azure.maps.data.models
    ...
    def begin_upload_preview(
        ...
        * ``application/octet-stream``
        ...
        :type upload_data_format: str or ~azure.maps.data.models.UploadDataFormat
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.data.models.LongRunningOperationResult]
    ...
    def list_preview(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.data.models.MapDataListResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def _update_preview_initial(
        ...
        update_content,  # type: Union[IO, Any]
        upload_data_description=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.LongRunningOperationResult"]
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        if header_parameters['Content-Type'].split(";")[0] in ['application/octet-stream']:
            body_content_kwargs['stream_content'] = update_content
        elif header_parameters['Content-Type'].split(";")[0] in ['application/json']:
    ...
    def get_operation_preview(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.maps.data.models.LongRunningOperationResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.LongRunningOperationResult"]
        error_map = {
