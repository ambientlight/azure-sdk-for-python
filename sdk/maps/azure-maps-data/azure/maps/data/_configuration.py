...
class MapsDataClientConfiguration(Configuration):
    """Configuration for MapsDataClient.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(MapsDataClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-data/{}'.format(VERSION))
