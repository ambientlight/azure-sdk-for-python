...
class SearchOperations:
    ...
    async def post_search_fuzzy_batch_sync(
        self,
        format: Union[str, "_models.ResponseFormat"],
    ...
    async def _get_search_fuzzy_batch_initial(
        self,
        format: str,
        **kwargs: Any
    ...
    async def begin_get_search_fuzzy_batch(
        self,
        format: str,
        **kwargs: Any
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._get_search_fuzzy_batch_initial(
                format=format,
                cls=lambda x,y,z: x,
                **kwargs
            )
    ...
    async def _get_search_address_reverse_batch_initial(
        self,
        format: str,
        **kwargs: Any
    ...
    async def begin_get_search_address_reverse_batch(
        self,
        format: str,
        **kwargs: Any
        ...
        *
        ...
        cont_token = kwargs.pop('continuation_token', None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._get_search_address_reverse_batch_initial(
                format=format,
                cls=lambda x,y,z: x,
                **kwargs
            )
