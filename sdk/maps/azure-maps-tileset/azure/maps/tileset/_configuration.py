...
class MapsTilesetClientConfiguration(Configuration):
    """Configuration for MapsTilesetClient.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(MapsTilesetClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-tileset/{}'.format(VERSION))
