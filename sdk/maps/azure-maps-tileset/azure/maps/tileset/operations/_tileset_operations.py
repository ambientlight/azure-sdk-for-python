...
class TilesetOperations(object):
    ...
    def begin_create(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.maps.tileset.models.LongRunningOperationResult]
    ...
    def list(
        ...
        **Applies to:** see pricing `tiers <https://aka.ms/AzureMapsPricingTier>`_.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.maps.tileset.models.TilesetListResponse]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
