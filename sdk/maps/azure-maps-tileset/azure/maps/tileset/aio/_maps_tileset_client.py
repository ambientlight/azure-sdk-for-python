...
from ._configuration import MapsTilesetClientConfiguration
from .operations import TilesetOperations
from .. import models


class MapsTilesetClient(object):
    """APIs for managing Tilesets.

    :ivar tileset: TilesetOperations operations
    :vartype tileset: azure.maps.tileset.aio.operations.TilesetOperations
    ...
    :type geography: str or ~azure.maps.tileset.models.Geography
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsTilesetClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsTilesetClient":
