...
class MapsMobilityClientConfiguration(Configuration):
    """Configuration for MapsMobilityClient.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(MapsMobilityClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault('sdk_moniker', 'maps-mobility/{}'.format(VERSION))
