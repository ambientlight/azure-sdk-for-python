...
from ._configuration import MapsMobilityClientConfiguration
from .operations import MobilityOperations
from .. import models


class MapsMobilityClient(object):
    """MapsMobilityClient.

    :ivar mobility: MobilityOperations operations
    :vartype mobility: azure.maps.mobility.aio.operations.MobilityOperations
    ...
    :type geography: str or ~azure.maps.mobility.models.Geography
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = MapsMobilityClientConfiguration(credential, x_ms_client_id, geography, **kwargs)
    ...
    async def __aenter__(self) -> "MapsMobilityClient":
