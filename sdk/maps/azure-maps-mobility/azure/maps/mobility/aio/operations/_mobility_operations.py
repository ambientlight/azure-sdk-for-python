...
class MobilityOperations:
    ...
    async def get_metro_area_preview(
        ...
        query: str,
        query_type: Optional[Union[str, "_models.MetroAreaQueryType"]] = None,
    ...
    async def get_transit_stop_info_preview(
        ...
        query: str,
        metro_id: Optional[int] = None,
        query_type: Optional[Union[str, "_models.TransitStopQueryType"]] = None,
    ...
    async def get_transit_route_preview(
        ...
        destination: str,
        metro_id: Optional[int] = None,
        origin_type: Optional[Union[str, "_models.OriginType"]] = None,
        ...
        time_type: Optional[Union[str, "_models.TimeType"]] = None,
        route_type: Optional[Union[str, "_models.TransitRouteType"]] = None,
    ...
    async def get_real_time_arrivals_preview(
        ...
        query: str,
        metro_id: Optional[int] = None,
        query_type: Optional[Union[str, "_models.RealTimeArrivalsQueryType"]] = None,
        stop_query_type: Optional[Union[str, "_models.StopQueryType"]] = None,
        limit: Optional[int] = None,
