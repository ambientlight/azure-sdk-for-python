...
class MobilityOperations(object):
    ...
    :type models: ~azure.maps.mobility.models
    ...
    def get_metro_area_preview(
        ...
        query,  # type: str
        query_type=None,  # type: Optional[Union[str, "_models.MetroAreaQueryType"]]
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type format: str or ~azure.maps.mobility.models.ResponseFormat
        ...
        :type query_type: str or ~azure.maps.mobility.models.MetroAreaQueryType
        ...
        :rtype: ~azure.maps.mobility.models.MetroAreaResponse
    ...
    def get_metro_area_info_preview(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type detail_type: list[str or ~azure.maps.mobility.models.MetroAreaDetailType]
        :param language: Language in which search results will be returned.  Only NGT is supported.
         Please refer to `Supported languages
         <https://docs.microsoft.com/azure/azure-maps/supported-languages>`_ for details.
        :type language: str
        ...
        :rtype: ~azure.maps.mobility.models.MetroAreaInfoResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_nearby_transit_preview(
        ...
        object_type=None,  # type: Optional[str]
        language=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :rtype: ~azure.maps.mobility.models.NearbyTransitResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_transit_line_info_preview(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type detail_type: list[str or ~azure.maps.mobility.models.TransitLineDetailType]
        :param language: Language in which search results will be returned.  Only NGT is supported.
         Please refer to `Supported languages
         <https://docs.microsoft.com/azure/azure-maps/supported-languages>`_ for details.
        :type language: str
        ...
        :rtype: ~azure.maps.mobility.models.TransitLineInfoResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_transit_stop_info_preview(
        ...
        query,  # type: str
        metro_id=None,  # type: Optional[int]
        query_type=None,  # type: Optional[Union[str, "_models.TransitStopQueryType"]]
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :param query_type: The type of the unique query parameter of the stop. By default
         queryType=stopId.
        :type query_type: str or ~azure.maps.mobility.models.TransitStopQueryType
        ...
        :type detail_type: list[str or ~azure.maps.mobility.models.TransitStopDetailType]
        :param language: Language in which search results will be returned.  Only NGT is supported.
         Please refer to `Supported languages
         <https://docs.microsoft.com/azure/azure-maps/supported-languages>`_ for details.
        :type language: str
        ...
        :rtype: ~azure.maps.mobility.models.TransitStopInfoResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_transit_route_preview(
        ...
        metro_id=None,  # type: Optional[int]
        origin_type=None,  # type: Optional[Union[str, "_models.OriginType"]]
        destination_type=None,  # type: Optional[Union[str, "_models.DestinationType"]]
        ...
        time_type=None,  # type: Optional[Union[str, "_models.TimeType"]]
        route_type=None,  # type: Optional[Union[str, "_models.TransitRouteType"]]
        bike_type=None,  # type: Optional[str]
        language=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :param origin_type: The type of the origin. By default originType=position, specified as a
         ...
         "47.641268,-122.125679”.
        :type origin_type: str or ~azure.maps.mobility.models.OriginType
        :param destination_type: The type of the destination.
        :type destination_type: str or ~azure.maps.mobility.models.DestinationType
        ...
        :type mode_type: list[str or ~azure.maps.mobility.models.ModeType]
         ...
         * ``tram`` - Tram
         * ``subway`` - Subway/Metro.
        :type transit_type: list[str or ~azure.maps.mobility.models.TransitTypeFilter]
        ...
        :type agency_type: str or ~azure.maps.mobility.models.AgencyType
        ...
        :type time_type: str or ~azure.maps.mobility.models.TimeType
        :param route_type: The type of route requested. If not specified, 'optimal' will be used.
        :type route_type: str or ~azure.maps.mobility.models.TransitRouteType
        ...
        :rtype: ~azure.maps.mobility.models.TransitRouteResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_transit_itinerary_preview(
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type detail_type: list[str or ~azure.maps.mobility.models.TransitItineraryDetailType]
        :param language: Language in which search results will be returned.  Only NGT is supported.
         Please refer to `Supported languages
         <https://docs.microsoft.com/azure/azure-maps/supported-languages>`_ for details.
        :type language: str
        ...
        :rtype: ~azure.maps.mobility.models.TransitItineraryResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_real_time_arrivals_preview(
        ...
        query,  # type: str
        metro_id=None,  # type: Optional[int]
        query_type=None,  # type: Optional[Union[str, "_models.RealTimeArrivalsQueryType"]]
        stop_query_type=None,  # type: Optional[Union[str, "_models.StopQueryType"]]
        limit=None,  # type: Optional[int]
        ...
        **Applies to**\ : S1 pricing tier.
        ...
        :type query_type: str or ~azure.maps.mobility.models.RealTimeArrivalsQueryType
        ...
        :type stop_query_type: str or ~azure.maps.mobility.models.StopQueryType
        ...
        :rtype: ~azure.maps.mobility.models.RealTimeArrivalsResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
